...
sofabuilder.add_convex_collision_from_file(filename="/home/rob/rigid_body_mesh/sofa/sofa.obj",scale=[1,1,1])
sofabuilder.add_visual_from_file(filename="/home/rob/rigid_body_mesh/sofa.glb",scale=[1,1,1])
...
chairbuilder.add_convex_collision_from_file(filename="/home/rob/rigid_body_mesh/chair/chair.obj",scale=[0.55,0.55,0.55])
chairbuilder.add_visual_from_file(filename="/home/rob/rigid_body_mesh/chair.glb",scale=[0.55,0.55,0.55])
...
tablebuilder.add_convex_collision_from_file(filename="/home/rob/rigid_body_mesh/table/table.obj",scale=[0.7,0.7,0.7])
tablebuilder.add_visual_from_file(filename="/home/rob/rigid_body_mesh/table.glb",scale=[0.7,0.7,0.7])
...
cotablebuilder.add_convex_collision_from_file(filename="/home/rob/rigid_body_mesh/coffeetable/coffeetable.obj",scale=[0.7,0.7,0.7])
cotablebuilder.add_visual_from_file(filename="/home/rob/rigid_body_mesh/coffeetable.glb",scale=[0.7,0.7,0.7])
cotable=cotablebuilder.build(name="coffeetable")

cubesofabuilder = scene.create_actor_builder()
cubesofabuilder.add_convex_collision_from_file(filename="/home/rob/rigid_body_mesh/cubesofa/cubesofa.obj",scale=[0.35,0.35,0.35])
cubesofabuilder.add_visual_from_file(filename="/home/rob/rigid_body_mesh/cubesofa.glb",scale=[0.35,0.35,0.35])
...
cuboidsofabuilder.add_convex_collision_from_file(filename="/home/rob/rigid_body_mesh/cuboidsofa/cuboidsofa.obj",scale=[0.55,0.55,0.55])
cuboidsofabuilder.add_visual_from_file(filename="/home/rob/rigid_body_mesh/cuboidsofa.glb",scale=[0.55,0.55,0.55])
