...
class PickClothEnv(BaseEnv):
    ...
    def __init__(
        ...
        *args,
        ...
        cloth_init_pose=sapien.Pose([-0.1, -0.1, 0.6]),
    ...
    def _setup_scene(self):
        ...
        assert len(self._scene.sub_scenes) == 1, "currently only single scene is supported" ##scene   _scene

        for s in self._scene.sub_scenes:  ##scene   _scene
        ...
        self._scene.sub_scenes[0].add_entity(entity)  ##scene   _scene
    ...
    def _after_reconfigure(self, options):
        ...
        self._scene.sub_scenes[0].add_entity(cloth_entity)   ##scene   _scene
